...
# ------------------------------------------------------------
# These lists give the templates some variation so the
# synthetic messages are not all identical.
...
# scam templates
# ------------------------------------------------------------
# These match the scam patterns used in the project.
...
def generate_synthetic_scam_messages(
    ...
    # Generate synthetic scam messages for the dataset.
    # All generated rows are labeled as scam.
    # All generated rows are clearly marked as synthetic.
    # We also try to avoid exact duplicates.
